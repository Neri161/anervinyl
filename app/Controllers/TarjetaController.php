...
class TarjetaController
{
    function crear()
    {
        ...
        $pre->bind_param("ssssssss", $this->folio_Tarjeta, $this->fechVencimiento, $this->noSeguridad, $this->correo, $this->contrasenia, $this->fecha_registro,$this->compania,$this->id_Usuario);
        $pre->execute();
    }
}