                ...
                <div class="row" id="col">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="nombre">Nombre Aristico: </label>
                            <input type="text" name="nombre_Artistico" id="nombre_Artistico" class="form-control" placeholder="Nombre Artistico" required>
                        </div>
                    </div>
